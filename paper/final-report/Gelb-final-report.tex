...
\textsc{\large Benjamin Gelb}\\[0.5cm] % Minor heading such as course title
\textsc{}\\[0.5cm]
...
{\large Supervised By Dr. Joe Geigel \\ Department of Computer Science}\\[1.5cm] % Minor heading such as course title
{\large
...
Joe Geigel\\Associate Professor\\Project Committee Chair\\[8ex]% adds space between the two sets of signatures
\end{tabular}

\noindent\begin{tabular}{ll}
\makebox[2.5in]{\hrulefill} \\
Leon Reznik\\Professor\\Project Committee Reader\\[8ex]% adds space between the two sets of signatures
\end{tabular}

\noindent\begin{tabular}{ll}
\makebox[2.5in]{\hrulefill} \\
Hans-Peter Bischof\\Professor\\Project Committee Observer\\[8ex]% adds space between the two sets of signatures
\end{tabular}
